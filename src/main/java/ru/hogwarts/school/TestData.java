...
public class TestData {
    public static final String STUDENT_NAME_1 = "Phil Collins_TEST";
    ...
    public static final String FACULTY_NAME_3 = "Despair";

    public static final String FACULTY_COLOR_1 = "black";
    public static final String FACULTY_COLOR_2 = "brown";
    public static final String FACULTY_COLOR_3 = "green";
}
